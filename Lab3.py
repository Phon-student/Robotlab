...
#LINE TOKEN
LINE_NOTIFY_TOKEN = 'vZEqS5OO9vbBVyo5EUcmbyONUaqgLBI8Q2AlhzUFeXR'
...
while(True):
    ...
    ob_detected = False
    for ob in result_dict:
        if ob['name'] == 'uturn' or ob['name'] == 'SchoolZone' or ob['name'] == 'SpeedLimit-80 kmph' or ob['name'] == 'Pedestrian Crossing' or  ob['name'] == 'Bumps Ahead' :
            ob_detected = True
            break
